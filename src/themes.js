...
//  Theme Registry v6
//
//  CHILD THEMES (4 options):
//  ─ GALAXY ★ NEW "Galaxy Kids"     — deep purple + teal + gold (Concept B)
//  ─ SUNNY     "Sunny Quest"        — warm coral/orange + teal
//  ─ COSMIC    "Cosmic Adventure"   — deep space purple + electric blue
...
const THEMES = {
  ...
  /* ══════════════════════════════════════════════════════
     CHILD CONCEPT B — "Galaxy Kids" ★ DEFAULT
     Deep violet + electric teal + golden stars.
     High-contrast, Duolingo-energy, extremely clear hierarchy.
     Purple bg → white cards → teal/gold accents.
  ══════════════════════════════════════════════════════ */
  GALAXY: {
    id: 'GALAXY', name: 'Galaxy Kids 🚀', label: 'גלקסי', isGame: true,
    font: "'Heebo', sans-serif",

    // ── Backgrounds ──────────────────────────────────
    bgGrad:   'linear-gradient(170deg, #3D0066 0%, #5E35B1 45%, #283593 100%)',
    cardBg:   '#FFFFFF',
    panelBg:  '#FFFFFF',
    sheetBg:  '#F0EEFF',      // very light purple for pulled-up sheets

    // ── Brand colors ─────────────────────────────────
    primary:   '#7C4DFF',    // electric violet — main CTAs
    secondary: '#00BCD4',    // cyan-teal — success, done, secondary btns
    accent:    '#FFD54F',    // gold — stars, coins, highlights
    success:   '#00E676',    // bright green
    danger:    '#FF1744',    // red
    warning:   '#FF9800',    // orange
    purple:    '#EA80FC',    // light purple — decorative

    // ── Text (on white cards) ─────────────────────────
    text:          '#1A0033',   // very dark purple — primary text
    textMid:       '#3D2066',   // medium purple
    textLight:     '#7B5EA7',   // muted purple
    ...
    // ── Shadows ──────────────────────────────────────
    shadow:        '0 4px 20px rgba(62,0,102,.15)',
    cardShadow:    '0 6px 24px rgba(62,0,102,.12)',
    btnShadow:     '0 6px 20px rgba(124,77,255,.50)',
    successShadow: '0 6px 20px rgba(0,230,118,.40)',
    tealShadow:    '0 6px 20px rgba(0,188,212,.40)',
    ...
    // ── Gradients ────────────────────────────────────
    headerGrad:   'linear-gradient(135deg, #4A148C 0%, #7C4DFF 60%, #00BCD4 100%)',
    coinGrad:     'linear-gradient(145deg, #FFE57F 0%, #FFD54F 50%, #FFC107 100%)',
    progressGrad: 'linear-gradient(90deg, #7C4DFF 0%, #00BCD4 100%)',
    successGrad:  'linear-gradient(135deg, #00E676 0%, #00BCD4 100%)',
    tealGrad:     'linear-gradient(135deg, #00BCD4 0%, #00ACC1 100%)',

    // ── UI specifics ─────────────────────────────────
    navBg:      '#2D1B69',      // dark purple nav
    navActive:  '#7C4DFF',
    navText:    'rgba(255,255,255,.6)',
    navActiveText: '#FFFFFF',
    inputBg:    '#F3F0FF',
    progressBg: 'rgba(255,255,255,.18)',   // on dark bg

    // ── Coin ─────────────────────────────────────────
    coinBg: 'linear-gradient(145deg, #FFE57F 0%, #FFD54F 50%, #FFC107 100%)',
  },
  ...
  SUNNY: {
    ...
    tealGrad:    'linear-gradient(135deg, #00BCD4, #00ACC1)',
    navBg:       'rgba(255,255,255,.95)',
    navActive: '#FF5722', navText: '#8888A8', navActiveText: '#FF5722',
    inputBg:     '#FFF8F0',
  ...
  COSMIC: {
    ...
    tealShadow: '0 6px 20px rgba(0,229,255,.4)',
    ...
    tealGrad:    'linear-gradient(135deg, #00E5FF, #00ACC1)',
    navBg:       'rgba(20,5,50,.95)',
    navActive: '#7C4DFF', navText: 'rgba(255,255,255,.55)', navActiveText: '#FFFFFF',
  ...
  FOREST: {
    ...
    successShadow: '0 6px 20px rgba(0,230,118,.40)',
    tealShadow: '0 6px 20px rgba(206,147,216,.40)',
    border: 'none', cardBorder: 'none',
    ...
    successGrad: 'linear-gradient(135deg, #00E676, #69F0AE)',
    tealGrad:    'linear-gradient(135deg, #CE93D8, #BA68C8)',
    navBg:       'rgba(255,255,255,.97)',
    navActive: '#1B5E20', navText: '#5A7A5A', navActiveText: '#1B5E20',
    inputBg:     '#E8F5E9',
  ...
  C: {
    ...
    tealShadow: '0 4px 16px rgba(72,202,228,.30)',
    ...
    tealGrad: 'linear-gradient(135deg,#48CAE4,#0096C7)',
  ...
  A: {
    ...
    tealShadow: '0 4px 14px rgba(109,207,160,.40)',
    ...
    tealGrad: 'linear-gradient(135deg,#6DCFA0,#48CAE4)',
  ...
  B: {
    ...
    tealGrad: 'linear-gradient(135deg,#00C851,#00BCD4)',
  ...
  D: {
    ...
    tealGrad: 'linear-gradient(135deg,#2E8B57,#00BCD4)',
  ...
  E: {
    ...
    tealShadow: '0 4px 16px rgba(0,212,200,.38)',
    ...
    tealGrad: 'linear-gradient(135deg,#00D4C8,#0096C7)',
